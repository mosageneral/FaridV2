...
{
    public abstract class FaridV2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FaridV2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FaridV2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FaridV2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FaridV2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FaridV2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FaridV2DbContext, Task<T>> func)
        {
            T result;
